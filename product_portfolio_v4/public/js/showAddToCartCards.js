...
// import apply from "./couponApplied.js"
import coupons from "./api/coupons.json" assert { type: "json" };
import { apply } from "./couponApplied.js";
  ...
  const options = {
    ...
    handler: async function (response) {
        try {
            ...
            const validationResponse = await fetch('http://localhost:3000/validate-payment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (validationResult.success) {
                ...
                await handleOrder(userEmail, order.amount, cartProducts);
